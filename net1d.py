...
class Net1D(nn.Module):
    ...
    def __init__(self, in_channels, base_filters, ratio, filter_list, m_blocks_list, kernel_size, stride, groups_width, min_label=21, max_label=100, n_classes=1, use_bn=True, use_do=True, verbose=False):
